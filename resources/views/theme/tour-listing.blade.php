            ...
            <div class="row gutter-y-30 gutter-x-30">
               @foreach($tours as $t)
                <div class="col-lg-4 col-md-6">
                    ...
                    "items": [
                        {
                            "src": "{{asset('assets/images/blog/listing-1-1.jpg')}}"
                        },
                        {
                            "src": "{{asset('assets/images/blog/listing-1-2.jpg')}}"
                        },
                        {
                            "src": "{{asset('assets/images/blog/listing-1-3.jpg')}}"
                        }
                    ],
                    "gallery": {
                        "enabled": true
                ...
                <div class="col-lg-6">
                    <div class="about-one__thumb wow fadeInLeft" data-wow-duration='1500ms' data-wow-delay='300ms'>
                        <div class="about-one__thumb__item  ">
                            <img src="{{asset('assets/images/about/about-1-1.jpg')}}" alt="gotur image">
