            ...
            <div class="main-card">
                <div class="card-header-custom">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="fw-semibold text-secondary">Bus Registration Form</span>
                    </div>
                </div>
                ...
                <div class="card-body-custom">
                    ...
                    <form action="{{ route('admin.bus.store') }}" method="POST" id="busForm">
                        @csrf
                            ...
                            <div class="row g-4">
                                <div class="col-12">
                                    <label class="form-label">
                                        Bus Name / Registration Number <span class="required">*</span>
                                    </label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group-custom">
                                        ...
                                        <input type="number" class="form-control @error('total_seat') is-invalid @enderror"
                                               name="total_seat" value="40" min="1" max="100"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="d-flex gap-2 flex-wrap" id="busTypeGroup">
                                        <label class="bus-type-option flex-fill text-center" data-type="ac">
                                            <input type="radio" name="bus_type" value="ac" {{ old('bus_type') == 'ac' ? 'checked' : '' }} required>
                                            <i class="ti ti-snowflake" style="font-size: 1.25rem;"></i>
                                            <span class="d-block small mt-1">AC</span>
                                        </label>
                                        <label class="bus-type-option flex-fill text-center" data-type="non-ac">
                                            <input type="radio" name="bus_type" value="non-ac" {{ old('bus_type') == 'non-ac' ? 'checked' : '' }}>
                                            <i class="ti ti-wind" style="font-size: 1.25rem;"></i>
                                            <span class="d-block small mt-1">Non-AC</span>
                                        </label>
                                        <label class="bus-type-option flex-fill text-center" data-type="sleeper">
                                            <input type="radio" name="bus_type" value="sleeper" {{ old('bus_type') == 'sleeper' ? 'checked' : '' }}>
                                            <i class="ti ti-bed" style="font-size: 1.25rem;"></i>
                                            <span class="d-block small mt-1">Sleeper</span>
                                        </label>
                                        <label class="bus-type-option flex-fill text-center" data-type="luxury">
                                            <input type="radio" name="bus_type" value="luxury" {{ old('bus_type') == 'luxury' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="status-toggle">
                                        <div class="status-option">
                                            <input type="radio" name="status" value="active" id="statusActive" {{ old('status') == 'active' ? 'checked' : '' }} required>
                                        ...
                                        <div class="status-option">
                                            <input type="radio" name="status" value="inactive" id="statusInactive" {{ old('status') == 'inactive' ? 'checked' : '' }}>
                                        ...
                                        <div class="status-option">
                                            <input type="radio" name="status" value="maintenance" id="statusMaintenance" {{ old('status') == 'maintenance' ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="exp-slider">
                                        <input type="range" class="form-range" id="experienceSlider"
                                               ...
                                               value="{{ old('driver_exp', 5) }}">
                                        <div class="d-flex justify-content-between mt-2">
                                            <span class="small text-muted">0 years</span>
                                            <span class="exp-value" id="expValue">{{ old('driver_exp', 5) }} years</span>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control" name="notes" rows="3"
                                              placeholder="Any additional information about the bus or driver...">{{ old('notes') }}</textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="action-buttons">
                            ...
                            <button type="submit" class="btn-save">
                                <i class="ti ti-device-floppy me-2"></i>Save Bus
                            </button>
                        </div>
                    </form>
                </div>
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            // Set active class on page load if any radio is checked
            $('.bus-type-option').each(function() {
            ...
            $('#resetBtn').click(function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $('.bus-type-option').removeClass('active');
                        if (slider) {
                            slider.value = 5;
                            expValue.textContent = '5 years';
                        }
                        Swal.fire({
                            title: 'Reset!',
