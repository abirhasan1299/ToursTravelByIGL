...
<head>
    ...
    <title>Forget password · OTP timer</title>
...
<div class="card">
    ...
    <!-- Form starts -->
    <form action="{{route('auth.verify.otp')}}" method="post" autocomplete="off">
        @csrf
        ...
        <div class="input-group">
            ...
            <div class="input-wrapper">
                ...
                <i class="fas fa-asterisk input-icon" style="font-size: 0.9rem;"></i>
        ...
        <!-- Requirement pills (dynamic match) -->
        <div class="password-requirements" id="reqPills">
            <span class="req-item"><i class="fas fa-circle-check" style="color:#1e7e34;"></i> 8+ chars</span>
            <span class="req-item"><i class="fas fa-circle-check" style="color:#1e7e34;"></i> upper & lower</span>
            <span class="req-item"><i class="fas fa-circle-check" style="color:#1e7e34;"></i> number</span>
            <span class="req-item" id="matchPill"><i class="fas fa-circle-check"></i> match</span>
        </div>
