{{-- resources/views/admin/album-show.blade.php --}}
    ...
    <div class="container-fluid py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted">{{ $photos->count() }} photos in this album</p>
            </div>
        ...
        <div class="card shadow-sm border-0 rounded-4 mb-5">
            <div class="card-body p-4">
                <h5 class="card-title mb-3"><i class="fas fa-cloud-upload-alt me-2" style="color: #3061fd;"></i>Upload Photos to {{ $album->name }}</h5>
                <form method="POST" action="{{ route('admin.album.photos.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mt-3 d-flex justify-content-end">
                        <button type="submit" class="btn btn-primary px-5 py-2" id="uploadSubmitBtn" disabled>
                            <i class="fas fa-upload me-2"></i>Upload to Album
                        </button>
                    </div>
                </form>
            </div>
                    ...
                    <table class="table table-hover align-middle mb-0">
                        ...
                        @forelse($photos as $photo)
                            <tr data-id="{{ $photo->id }}">
                                ...
                                <td class="text-muted">{{ $photo->img_name }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-5">
                                    ...
                                    <p class="text-muted mb-0">No photos uploaded to this album yet</p>
                                </td>
                            </tr>
                        @endforelse
                        </tbody>
            ...
            document.querySelectorAll('.delete-single').forEach(btn => {
                btn.addEventListener('click', async function(e) {
                    ...
                    if (result.isConfirmed) {
                        singleDeleteForm.action = `/album/photos/${photoId}`;
