            ...
            <div class="main-card">
                <div class="card-header-custom">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <span class="fw-semibold text-secondary">Edit Package Information</span>
                    </div>
                </div>
                ...
                <div class="card-body-custom">
                    ...
                    <form action="{{ route('admin.post.update', base64_encode($package->id)) }}" method="POST" enctype="multipart/form-data" id="packageForm">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="image-upload-area" id="imageUploadArea">
                                        @if($package->cover_img)
                                            <div class="current-image-container">
                                                <img src="{{ asset('storage/package/' . $package->cover_img) }}"
                                                     class="current-image" alt="Current Cover">
                                                <span class="image-overlay">Current Image</span>
                                            </div>
                                            <p class="mt-3 mb-1 fw-medium text-primary">
                                                <i class="ti ti-photo-edit me-1"></i> Click to change image
                                            </p>
                                        @else
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control @error('amount') is-invalid @enderror border-start-0 rounded-start-0"
                                               name="amount" value="{{ old('amount', $package->amount) }}" min="0" placeholder="Enter amount" required>
                                    </div>
                                    @error('amount')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('max_people') is-invalid @enderror"
                                           name="max_people" value="{{ old('max_people', $package->max_people) }}" min="1" placeholder="Maximum participants" required>
                                    @error('max_people')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="action-buttons">
                            <a href="{{ route('admin.post.index') }}" class="btn-cancel">
                                <i class="ti ti-x me-2"></i>Cancel
                            </a>
                            <button type="submit" class="btn-update">
                                <i class="ti ti-device-floppy me-2"></i>Update Package
                            </button>
                        </div>
                    </form>
                </div>
            ...
            coverImageInput.addEventListener('change', function(e) {
                if (e.target.files && e.target.files[0]) {
                    ...
                    reader.onload = function(e) {
                        ...
                        const currentImage = document.querySelector('.current-image-container');
                        if (currentImage) {
